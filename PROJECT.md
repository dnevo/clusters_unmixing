...
A secondary cluster set, `6clusters_digitized`, was deprecated and has been removed. Only
...
notebooks/experiment_review.ipynb        interactive review notebook
...
Notebook-only dependencies (for `notebooks/experiment_review.ipynb` and
...
- **`6clusters_digitized.csv` was deprecated and has been removed** from the repo.
